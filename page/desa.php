...
?>
<h2 class="page-header"><i class="fa fa-archive">&nbsp;</i>Page Desa</h2>
					...
					<div class="modal-dialog modal-sm" role="document">
					    <div class="modal-content">
					    	<div class="modal-header">
					    		...
					    		<h4 class="modal-title" id="myModalLabel">Input Data Desa</h4>
					    	</div>
					  		<form>
						    	<div class="modal-body">
						    		...
						    		<div class="form-group form-group-sm">
						    			<label for="nama_kepCamat">Nama Kepala Desa</label>
						    			<input type="text" id="nama_kepDesa" class="form-control" placeholder="Nama Kepala Desa">
						    		</div>
						    	</div>
					    	</form>
...
<script src="ajax/desa.js"></script>